...
const EnrolledCourses = () => {
    ...
    const EnrolledCourses = cart.filter(enrolledCourse => enrolledCourse.paymentStatus === 'paid');
        ...
        <div>
            ...
            <div className="overflow-x-auto">
                <table className="table">
                    ...
                    <tbody>
                        {
                            EnrolledCourses.map((cartItem, index) => <tr key={cartItem._id} className=" hover">
                                <th>{index + 1}</th>
                                <td>{cartItem.name}</td>
