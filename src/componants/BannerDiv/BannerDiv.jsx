        ...
        <div className='w-full bg-red-800'>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-full flex items-center z-10 w-1/2 ">
                <div className='text-white space-y-5'>
                   <Slide> <h2 className='text-6xl font-bold '>Experience compassionate cardiac care</h2></Slide>
                   <Fade delay={1e3} cascade damping={1e-1}><p className='text-md '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione eum quam quaerat sequi tempora velit commodi error tenetur repellat inventore enim maxime, reiciendis sint laboriosam!</p></Fade>
